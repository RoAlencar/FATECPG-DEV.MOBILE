...
class _HomeState extends State<Home> {
  ...
  _carrosel() {
    return Container(
      ...
      child: PageView(
        children: <Widget>[
          _infoCarroucel('Desenvolvedor Backend', '3000,00',
              'Desenvolver em backend', '(11) 9 9999-9999'),
          _infoCarroucel('Engenheiro de Dados', '100,00',
              'Administrar Banco de Dados', '(11) 9 9888-9999'),
        ],
      ),
    );
  }
